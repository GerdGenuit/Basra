...
/**
 * Utilities for the Refugee model.
 * 
 * @author Marie Genuit
 *
 */
public class HumanUtils {
	 ...
	 * a State, but mor important, also around an Refugee.
	 * This implementation creates a set of "pie slices" within a circle around the State/ Refugee. 
	 * 
	 * @param center the current State location coordinate

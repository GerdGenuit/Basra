...
public class HumanStyle implements MarkStyle<Human>{
	...
	public HumanStyle() {
		...
		// kann man das so programmieren, dass sich die Punkte beim rausscrollen auch verkleinern?
		// kann man den Flüchtlingen auch eine Linie zur Nachverfolgung geben? Sodass man den Weg den sie
		// genommen haben anhand einer Linie nachvollziehen kann?
	
		String fileNameFemale = "icons/Roter-punkt-klein.svg.png";
		String fileNameMale = "icons/Blauer-punkt-klein.svg.png";
